...
class generate_training_files:
    ...
    def run(self):
        ...
        with cd(self.common_files):
            ...
            ###### using python
            self.split_files_cv(self.true_peaks, 500, 10, 'foregroundMarchantia_polimorpha', bed=self.true_bed)
            ...
            self.split_files_cv(self.randomfasta, 500, 10, 'background_cgMarchantia_polimorpha')
...
shape_target = generate_training_files('Marchantia_polimorpha', 'MYC2', '51', 'MpoMYCH1_51bp.fa', 'MpoMYCH1_51bp.bed',
                                       'meme.xml', 'meme.txt',
                                       'mar_shape',
                                       'http://marchantia.info/download/tak1v5.1/MpTak1v5.1.fasta',
